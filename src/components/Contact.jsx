  ...
  return (
    <div id="Contact" className="flex min-h-[70vh] min-w-full items-center justify-center">
      <div className="flex flex-col items-center justify-center gap-6 p-14">
        <h1 className="text-center text-5xl md:text-7xl font-bold bg-gradient-to-r from-indigo-500 to-blue-500 bg-clip-text text-transparent">
          Get in Touch
        </h1>
        <p className="text-center text-xl md:text-2xl font-light text-gray-400 max-w-[500px] leading-relaxed">
