...
const Contact = () => {
  const handleClick = () => {
    const userConfirmed = window.confirm("Do you want to open your email client?");
    if (userConfirmed) {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center gap-3 space-y-6 p-14">
      ...
      Wanto to chat? send me a e-mail through this bottom and i'll get back to you as soon as possible.
